...
export class BaseScene extends Phaser.Scene {
     ...
     */
    protected addOtherPlayer(playerData: PlayerData, factory: OtherPlayerFactory, callbacks: MultiplayerCallbacks) {
    ...
    protected updateScene(_time: number, _delta: number) {}
}
